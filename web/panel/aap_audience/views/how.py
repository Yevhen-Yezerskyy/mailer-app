# FILE: web/panel/aap_audience/views/how.py  (обновлено — 2025-12-18)
# CHANGE: исправлены импорты после переезда аппа под panel/,
#         логика НЕ менялась, БД/таблицы/поведение прежние.

import json

from django.shortcuts import render, redirect, get_object_or_404

from panel.aap_audience.forms import AudienceHowForm
