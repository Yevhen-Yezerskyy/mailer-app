...
# CHANGE:
# - mail_servers_smtp теперь ведёт на отдельную страницу SMTP.
# - mail_servers_imap теперь ведёт на отдельную страницу IMAP (пока stub, но URL уже “правильный на будущее”).
