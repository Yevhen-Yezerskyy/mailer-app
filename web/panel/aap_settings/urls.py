...
urlpatterns = [
    ...
    path("mail-servers/archive/modal/", mail_servers.mail_servers_archive_modal_view, name="mail_servers_archive_modal"),
    path("mail-servers/activate/modal/", mail_servers.mail_servers_activate_modal_view, name="mail_servers_activate_modal"),
