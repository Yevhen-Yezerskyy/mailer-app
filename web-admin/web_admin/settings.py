...
MIDDLEWARE = [
    ...
    "web_admin.tw_classmap_middleware.TailwindClassMapMiddleware",
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "web_admin" / "templates", WEB_DIR / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "web_admin.context_processors.panel_context",
            ],
        },
    },
]
